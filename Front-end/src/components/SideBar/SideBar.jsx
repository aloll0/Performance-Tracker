        ...
        <nav className="flex flex-col gap-3">
          {menuItems[0].items.map((item, index) => (
            <a
              key={index}
              href={item.link}
              className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-300 hover:pl-6"
            >
              {item.icon}
      ...
      <nav className="flex flex-col gap-3 mt-5">
        {menuItems[1].items.map((item, index) => (
          <a
            key={index}
            href={item.link}
            className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 hover:pl-6 
              ${
                item.logout
          ...
          >
            {item.icon}
            <p className={`text-lg ${item.logout ? "text-red-400" : ""}`}>
              {item.title}
            </p>
          </a>
        ))}
